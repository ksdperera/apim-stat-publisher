...
public class RequestPublisherTest extends AbstractPublisher {
    public RequestPublisherTest(DataPublisher publisher, int eventCount, int delay) {
        this.publisher = publisher;
        this.eventCount = eventCount;
        this.delay = delay;
        this.streamId = DataBridgeCommonsUtils.generateStreamId("org.wso2.apimgt.statistics.request.test", "1.0.0");
    }

    private RequestPublisherTest() {
